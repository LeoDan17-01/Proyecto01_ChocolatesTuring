...
public class AMDFactory implements ComponenteFactory {
   /**
     * Crea una CPU AMD segun el modelo solicitado.
     *
    ...
    public CPU crearCPU(String modelo) {
        switch(modelo) {
            case "i3-13100": 
                return new AMDCPU("Core i3-13100", 1200, 4, "AM4");
            case "i5-13600K": 
                return new AMDCPU("Core i5-13600K", 2500, 6, "AM4");
            case "i7-13700K":
                return new AMDCPU("Core i7-13700K", 3500, 8, "AM4");
            case "i9-13900K":
                return new AMDCPU("Core i9-13900K", 5000, 12, "AM4");
            default:
